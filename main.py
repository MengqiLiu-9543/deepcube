...
class SimpleRubiksCube:
    ...
    def apply_move(self, move):
        ...
        adjacent_faces = {
            ...
            # 左面 (1)旋转影响：上(0)的左列、后(4)的右列、下(5)的左列、前(2)的左列
            1: [(0, 0, False), (4, 2, True), (5, 0, False), (2, 0, False)],
            # 右面 (3)旋转影响：上(0)的右列、后(4)的左列、下(5)的右列、前(2)的右列 
            3: [(0, 2, False), (4, 0, True), (5, 2, False), (2, 2, False)]
        }
